...
@Component("PostConfirmChangeEmailAfterLoginResponder")
@Scope("prototype")
public class ConfirmChangeEmailAfterLoginResponderImp implements PostRequestWithPathVariableResponder{
	private ApplicationContext appContext;
	private RequestBodyVerifier bodyVerifier;
	
	public ConfirmChangeEmailAfterLoginResponderImp(ApplicationContext appContext, RequestBodyVerifier bodyVerifier) {
	...
	private void checkRequestBody(PostRequestBody requestBody) {
		String[] namesWhichAreSupposedToBeIncludedInTheBody = {"codeReceivedViaEmail", "newEmail"};
